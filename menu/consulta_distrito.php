    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                    <span class="login100-form-title">Sinistralidades por Distrito</span>
                    ...
                    <div class="table100-body js-pscroll">
                        <table>
                            ...
                            <?php
                                ...
                                $conn = accessBD();
                                $sql = "Select * From sinistralidades WHERE concelho IN (SELECT nome_concelho FROM concelhos WHERE cod_distrito = (SELECT cod_distrito FROM distritos WHERE nome_distrito = $1 LIMIT 1))";

                                $result = pg_prepare($conn, "query", $sql);
                                $result = pg_execute($conn, "query", array($consulta_dis));
