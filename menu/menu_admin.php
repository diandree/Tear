...
<body>
    <div class="topnav">
        ...
        <a href="../registo_utilizador.php">Registar Utilizador</a>
    ...
    ?>
    <div class="invalido">
        <p>ERRO: Não foi possível apagar o registo. Tente novamente.</p>
    </div>
    <?php
        endif;
                        ...
                        <table>
                            ...
                            ?>
                                        <tr class="row100 body">
                                            ...
                                            <td class="cell100 column9"> <?php echo "<a href='../delete.php?id=".
                                                $arr["cod_sin"]."' onclick=\"return confirm('Apagar Registo? Esta ação não pode ser revertida!')\">Delete</a>"?> </td>
                                        </tr>
                                <?php
                                    }
                                }
